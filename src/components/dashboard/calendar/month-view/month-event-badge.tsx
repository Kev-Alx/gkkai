...
import { DraggableEvent } from "@/components/dashboard/calendar/dnd/draggable-event";
import { EventDetailsDialog } from "@/components/dashboard/calendar/dialogs/event-details-dialog";
